...
betty.nodes = [
    new Node('0000', 'Take care!!', [], [{evtname:'nodeexit', detail:{currentsection:'bobstick'}}]),
    new Node('0001', '{betty.greetingText} |1000#So {gameplayer.name}...|1000#what did you want to ask me about?', [new NodeChoice('I want to talk to Bob now!', '6666,bob'), new NodeChoice('Guess the password!', 1117), new NodeChoice('Do the clicker prompt!', 1114), new NodeChoice('Update your startingNode!', 0009), new NodeChoice('Do you like it here?', 1000), new NodeChoice('How long have you lived here?', 2000),new NodeChoice('What\'s good here?', 3000), new NodeChoice('Are there good sticks in the forest?', 4000, 'quest_bobstick,!quest_bobstick2,stick<1'), new NodeChoice('Do the text prompt!', 1111), new NodeChoice("Nothing, take care!", "!")]),
