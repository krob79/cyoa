...
grampsHouse.nodes = [
    ...
    new Node('1000', "<p>You walk to the front porch of Gramps' house. To the right is a path that wraps around to the back of the house. There's not much here except an old rocking chair, and <a onClick='linkDispatchEvent(0)' return false;' href='#'>a polished walking stick</a>.</p>", [new NodeChoice("Take Stick", '1100', 'hidethis'),new NodeChoice("Take path to right of house (asleep)", '3000', 'newgramps<1'), new NodeChoice("Take path to right of house (awake)", '3001', "newgramps>0"), new NodeChoice("Leave", '!')]),
